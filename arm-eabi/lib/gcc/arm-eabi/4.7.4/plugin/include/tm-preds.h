/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/mnt/jenkins/workspace/linaro-android_toolchain-4.7-2014.01/build/objdir/../build/../gcc/gcc-linaro-4.7-2014.01/gcc/config/arm/arm.md'.  */
